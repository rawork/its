...
function refresh(){
	if(navigator.appName.indexOf('Microsoft')!=-1)
		dialogArguments.changeFolder(inpDest.value);
	else
		window.opener.changeFolder(document.getElementById('inpDest').value);
}
</script>
</head>
...
<table width=100% height=100% align=center style="" cellpadding=0 cellspacing=0 ID="Table1">
  <tr>
    <td valign=top style="padding-top:5px;padding-left:15px;padding-right:15px;padding-bottom:12px;height=100%"><br>
